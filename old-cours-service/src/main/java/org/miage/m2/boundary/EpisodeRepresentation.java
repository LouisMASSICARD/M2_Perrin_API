...
//            return ResponseEntity.ok().build();
    ...
    private CollectionModel<EntityModel<Episode>> episodeToResource(Iterable<Episode> episodes) {
        ...
        List<EntityModel<Episode>> intervenantResources = new ArrayList<EntityModel<Episode>>();
        episodes.forEach(intervenant -> intervenantResources.add(episodeToResource(intervenant, false)));
